  ...
  return (
    <footer className="border-t border-border/60 mt-24">
      <div className="container-luxe py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          <h4 className="text-xs uppercase tracking-[0.24em] text-muted-foreground mb-4">Explore</h4>
        ...
        <div>
          <h4 className="text-xs uppercase tracking-[0.24em] text-muted-foreground mb-4">Visit & Connect</h4>
